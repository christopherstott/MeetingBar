...
struct FullscreenNotificationPicker: View {
    ...
    @Default(.showFullscreenNotificationWithoutLink) var showFullscreenNotificationWithoutLink
        ...
        VStack(alignment: .leading) {
            ...
            if fullscreenNotification {
                HStack {
                    ...
                    Toggle("shared_fullscreen_notification_without_link_toggle".loco(), isOn: $showFullscreenNotificationWithoutLink)
                }
            }
        }
    }
